...
export default function HoverMsg(props:props) 
{
  ...
  return (
    <span
      className={`capitalize absolute ${styles} border-[1px] border-myBorder transition-all duration-200 text-[#fff] bg-[#30394c] py-[.2rem] px-[.4rem] w-fit whitespace-nowrap text-[.9rem] pointer-events-none rounded-[.3rem] z-[9999] ${
