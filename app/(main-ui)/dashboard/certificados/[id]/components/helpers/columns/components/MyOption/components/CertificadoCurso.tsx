    ...
    const element2 = (
        <div style={{ width: "100vw", height: "100vh" }}>
            <div style={{ position: "absolute", transform: "translate(-50%, -50%)", left: "36%", top: "30%", width: "40%" }}>
                ...
                <p className='textCentrado paddingHoja2' style={{ textTransform: "uppercase" }}>{data.name}</p>
                {
                    tipo === "nota" ? (
                        <>
                            ...
                            <table style={{ width: "180px", margin: "0 auto" }} className="paddingLetras">
                                <tr style={{ border: "1px solid black" }}>
                                    ...
                                    <td style={{ fontFamily: "Open Sans", fontSize: "11px", textAlign: "center", paddingTop: "5px", paddingBottom: "5px" }}>{data.average}</td>
                                </tr>
                            </table>
                        </>
                    ) : (<><br></br><br></br></>)
